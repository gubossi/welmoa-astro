...
# 사회복지시설 행정용어 총정리｜신규직원이 헷갈리는 실적·공문·예산·정산 용어
...
이번 글에서는 신입 사회복지사가 자주 접하는 행정용어를 실제 업무 흐름에 따라 정리해보겠습니다.

> **계획 → 승인 → 사업운영 → 실적관리 → 예산집행 → 결과보고 → 정산·평가**

## 목차

- [행정용어를 알면 업무의 흐름이 보입니다](#행정용어를-알면-업무의-흐름이-보입니다)
- [사업계획과 평가에서 사용하는 용어](#사업계획과-평가에서-사용하는-용어)
- [실적관리에서 사용하는 용어](#실적관리에서-사용하는-용어)
- [문서와 결재에서 사용하는 용어](#문서와-결재에서-사용하는-용어)
- [예산과 지출에서 사용하는 용어](#예산과-지출에서-사용하는-용어)
- [정산과 평가에서 사용하는 용어](#정산과-평가에서-사용하는-용어)
- [자주 헷갈리는 용어 비교](#자주-헷갈리는-용어-비교)
- [신규직원이 행정용어를 빨리 익히는 방법](#신규직원이-행정용어를-빨리-익히는-방법)
- [신규직원을 위한 업무 흐름 한눈에 보기](#신규직원을-위한-업무-흐름-한눈에-보기)

## 행정용어를 알면 업무의 흐름이 보입니다
...
현장에서는 목표를 **산출목표**와 **성과목표**로 구분하기도 합니다.
...
연인원은 등록인원에 회기 수를 단순히 곱하는 것이 아니라, 출석부에 기록된 실제 회기별 참석 인원을 합산해야 합니다.
...
계획과 실적은 반드시 같은 단위로 비교해야 합니다. 실인원 목표를 연인원 실적과 비교하거나, 프로그램 회기 목표를 상담 건수와 비교해서는 안 됩니다.
...
> **웰모아 한 줄 정리**  
> 품의는 **“이 지출을 해도 되는가?”**를 사전에 승인받는 과정이고, 지출결의는 **“실제로 얼마를 누구에게 지급할 것인가?”**를 처리하는 과정입니다.
...
행정용어를 익힌다는 것은 어려운 단어를 외우는 일이 아니라 **사회복지사업이 운영되는 과정을 이해하는 일**입니다.
