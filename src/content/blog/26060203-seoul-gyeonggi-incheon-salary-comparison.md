...
위 실수령액은 글 작성 당시 공개자료와 일정한 입력조건을 바탕으로 산출한 **예상 비교값**이며, 모든 사회복지시설에 공통으로 적용되는 확정 급여가 아닙니다. 실제 비교에서는 다음 조건을 동일하게 맞춰야 합니다.

| 확인항목 | 비교할 내용 |
| --- | --- |
| 시설 유형 | 사회복지관·이용시설·생활시설 등 동일 유형인지 |
| 직급·호봉 | 같은 직급의 1호봉인지 |
| 기본급 기준 | 보건복지부 기준인지 지자체 별도 기준인지 |
| 별도 수당 | 정액급식비·처우개선비·특수근무수당 포함 여부 |
| 지급 주기 | 매월 지급인지 명절·연간 지급인지 |
| 개인 조건 | 가족수당·시간외수당·비과세·부양가족 조건이 같은지 |

따라서 ‘서울 252만원, 인천 228만원, 경기 225만원’이라는 숫자는 지역 전체의 고정 순위로 해석하면 안 됩니다. 서울은 별도 임금체계, 경기도는 도와 시·군 사업의 결합, 인천은 직군별 추가 인상 등 구조가 서로 다릅니다. 이직이나 채용조건을 비교할 때는 해당 시설의 채용공고와 보수규정으로 다시 계산해야 합니다.

## 2026년 공식자료

- 서울특별시, [2026년 사회복지시설 종사자 임금·수당 처우개선](https://www.seoul.go.kr/news/news_report.do?bbsNo=158&cntPerPage=10&curPage=1&nttNo=450577)
- 경기도, [사회복지종사자 처우개선 사업 안내](https://www.gg.go.kr/contents/contents.do?ciIdx=1439&menuId=3239)
- 경기도뉴스포털, [2026년 처우개선비·웰빙보조비·장기근속수당 안내](https://gnews.gg.go.kr/news/news_detail.do?number=202601051053495401C109&s_code=C401)
- 인천광역시, [2026년 사회복지시설 종사자 지원기준](https://www.incheon.go.kr/welfare/WE050101)

※ 2026년 8월 2일 기준 각 지자체 공개자료를 확인했습니다. 실제 적용은 시설 유형과 재원, 시·군 및 기관 규정에 따라 달라질 수 있습니다.
