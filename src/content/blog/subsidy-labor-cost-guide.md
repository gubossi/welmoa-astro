...
보조금 인건비는 다음 순서로 확인하는 것이 안전합니다.

1. 교부결정서와 교부조건에서 지원 가능한 인건비 항목을 확인합니다.
2. 해당 보조사업의 집행지침과 보조비목·보조세목을 확인합니다.
3. 지자체 또는 중앙부처의 정산기준과 관리시스템 입력기준을 확인합니다.
4. 기관 보수규정과 근로계약에 따라 실제 지급의무가 있는 금액을 계산합니다.
5. 보조금으로 인정되지 않는 법정 지급의무가 있다면 자부담 등 다른 재원을 사전에 확보합니다.

2026년에는 국민연금과 건강보험 등 보험료율이 변경되었으므로 전년도 예산 산식만 그대로 사용하면 기관부담금이 부족해질 수 있습니다. 예산 부족이 예상되면 임의로 다른 비목에서 충당하기보다 교부기관에 예산변경 승인 또는 통보가 필요한지 먼저 확인해야 합니다.
...
※ 2026년 8월 2일 기준 공식자료를 확인했습니다. 실제 집행 가능 여부는 해당 사업의 교부조건과 담당 부서의 승인 내용을 우선 적용해야 합니다.
