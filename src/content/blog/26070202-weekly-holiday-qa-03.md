...
단시간근로자의 주휴시간은 **근무시간에 비례하여 계산**합니다.
...
주휴수당은 원칙적으로 **1주 소정근로시간이 15시간 이상인 근로자**에게 발생합니다.
...
| 사용자 귀책 휴업 | ⭕ | 휴업 사유 확인 |
| 병가 | 사례별 판단 | 취업규칙 확인 |
| 퇴직 예정자 | 사례별 판단 | 근로관계 종료 시점 |
| 단시간근로자 | 비례 계산 | 소정근로시간 확인 |
...
주휴수당 역시 **얼마를 지급할 것인지보다 '발생하는지'를 정확하게 판단하는 것이 더 중요한 업무**입니다.
